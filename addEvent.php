<?php
  ...
  if(isset($_POST['submit-button'])) {
    ...
    $event->addEvent($_POST['name'], $_POST['date'], $_POST['desc'], $_POST['price'], $_SESSION['sUsername']);
  }
?>
<html lang="en">
<head>
  ...
  <section class="container">
    <section class="content">
      ...
      <form method="post" action="">
        <input name="name" class="input-button" maxlength="20" type="text" placeholder="Event name  (max: 20)" />
        <input id="date" name="date" class="input-button" type="datetime-local" />
        <input name="price" class="input-button" type="text" placeholder="Price per person" />
        <textarea name="desc" class="input-button" maxlength="1000" type="text" placeholder="Description  (max: 1000)"></textarea>
